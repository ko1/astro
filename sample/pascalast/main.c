...
// ---------------------------------------------------------------------------
// Lexer / token kinds / next_token / expect / accept / tk_name /
// init_lexer / range_check_enabled all live in parse.c (parse.h).
// ---------------------------------------------------------------------------

// Human-readable Pascal type name (for type-error diagnostics).  PT_*
// is a parser-side kind, not a token, so it stays here.
static const char *
pt_name(int t)
{
    switch (t) {
