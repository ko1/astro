...
static RESULT ab_complex_inspect(CTX *c, VALUE self, unsigned int argc, VALUE *argv) {
    return RESULT_OK(abruby_str_new(rb_funcall(RCMPLX(self), rb_intern("inspect"), 0)));
}
static RESULT ab_complex_to_s(CTX *c, VALUE self, unsigned int argc, VALUE *argv) {
    return RESULT_OK(abruby_str_new(rb_funcall(RCMPLX(self), rb_intern("to_s"), 0)));
}
static RESULT ab_complex_to_f(CTX *c, VALUE self, unsigned int argc, VALUE *argv) {
    return RESULT_OK(abruby_float_new_wrap(rb_funcall(RCMPLX(self), rb_intern("to_f"), 0)));
}
...
static RESULT ab_complex_add(CTX *c, VALUE self, unsigned int argc, VALUE *argv) {
    return RESULT_OK(AB_NUM_WRAP(rb_funcall(RCMPLX(self), rb_intern("+"), 1, AB_NUM_UNWRAP(argv[0]))));
}
...
static RESULT ab_complex_neg(CTX *c, VALUE self, unsigned int argc, VALUE *argv) {
    return RESULT_OK(AB_NUM_WRAP(rb_funcall(RCMPLX(self), rb_intern("-@"), 0)));
}
...
static RESULT ab_complex_real(CTX *c, VALUE self, unsigned int argc, VALUE *argv) {
    return RESULT_OK(AB_NUM_WRAP(rb_funcall(RCMPLX(self), rb_intern("real"), 0)));
}
static RESULT ab_complex_imaginary(CTX *c, VALUE self, unsigned int argc, VALUE *argv) {
    return RESULT_OK(AB_NUM_WRAP(rb_funcall(RCMPLX(self), rb_intern("imaginary"), 0)));
}
static RESULT ab_complex_abs(CTX *c, VALUE self, unsigned int argc, VALUE *argv) {
    return RESULT_OK(AB_NUM_WRAP(rb_funcall(RCMPLX(self), rb_intern("abs"), 0)));
}
static RESULT ab_complex_conjugate(CTX *c, VALUE self, unsigned int argc, VALUE *argv) {
    return RESULT_OK(abruby_complex_new(rb_funcall(RCMPLX(self), rb_intern("conjugate"), 0)));
}
static RESULT ab_complex_rectangular(CTX *c, VALUE self, unsigned int argc, VALUE *argv) {
    VALUE real = AB_NUM_WRAP(rb_funcall(RCMPLX(self), rb_intern("real"), 0));
    VALUE imag = AB_NUM_WRAP(rb_funcall(RCMPLX(self), rb_intern("imaginary"), 0));
