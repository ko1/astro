 ...
 * runtime/astro_code_store.c.  Once we wire profile-guided
 * specialization in, HOPT picks up the runtime-recorded shape and
 * HORG keeps the static-only hash. */
