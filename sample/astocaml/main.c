...
// Lexer / token kinds / parse_fail / is_op_char / init_lexer all live
// in parse.c; see parse.h for the public surface.
...
// is_op_char moved to parse.c (declared in parse.h).
