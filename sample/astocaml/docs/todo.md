...
| ack    | 4093          | 0.090 s |
| fib    | 9227465       | 0.146 s |
| nqueens| 724 (×3)      | 0.275 s |
| sieve  | 3738566 (×8)  | 0.322 s |
| tak    | 9 (×5)        | 0.075 s |
...
|--|--|--|--|--|
| ack | **0.09** | 0.20 | 0.12 | 0.011 |
| fib | **0.15** | 0.38 | 0.20 | 0.040 |
| tak | **0.08** | 0.25 | 0.15 | 0.014 |
| nqueens | 0.28 | 0.22 | 0.17 | 0.017 |
| sieve | 0.32 | 0.26 | 0.23 | 0.019 |
