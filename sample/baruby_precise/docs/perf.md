...
### Plain mode matrix (iter 53 — SSO 投入後)

iter 49 matrix の string 系 (substr_churn / tokenize / string_concat_dyn /
string_concat) を SSO で書き直した数値。 非 string 系は iter 49 と
ほぼ同位 (±5% 範囲)。 大きな win: tokenize copy_gen 0.91→0.74
(-19%)、 substr_churn none 1.70→1.18 (-31%)、 libgc tokenize
1.39→1.14 (-18%)。
...
|---|---:|---:|---:|---:|---:|---:|---:|---:|---:|---:|---:|---:|---:|---:|---:|---:|
| ast_eval | 0.39 | 0.37 | 0.36 | 0.37 | 0.41 | 0.36 | 0.36 | 0.37 | 0.36 | 0.36 | 0.36 | 0.36 | 0.36 | **0.35** | 0.36 | 0.36 |
| binary_trees | 0.75 | 0.73 | 0.82 | 0.81 | 0.76 | 0.78 | 0.79 | 0.71 | **0.45** | 0.95 | 0.52 | 0.76 | 0.92 | 0.92 | 0.79 | 0.81 |
| cons_list | 1.15 | 0.76 | 0.87 | 0.89 | 0.72 | 0.74 | 0.83 | 0.73 | 0.85 | 0.72 | 0.72 | **0.68** | 0.86 | 0.85 | 0.73 | 0.91 |
| dll_walk | 1.02 | 0.77 | 0.83 | 0.85 | 0.74 | 0.77 | 0.82 | 0.76 | 0.83 | 0.76 | 0.71 | **0.71** | 0.82 | 0.82 | 0.77 | 0.88 |
| fannkuch | 0.78 | 0.74 | 0.78 | 0.79 | 0.76 | **0.70** | 0.72 | 0.72 | 0.75 | 0.71 | 0.71 | 0.78 | 0.79 | 0.78 | 0.74 | 0.75 |
| fib_pair | 1.41 | 0.86 | 1.00 | 1.09 | 0.75 | 0.83 | 0.92 | 0.79 | 0.97 | 0.83 | 0.78 | **0.72** | 1.01 | 0.96 | 0.79 | 1.06 |
| gc_combined | 1.22 | 0.81 | 0.90 | 0.90 | 0.74 | 0.75 | 0.87 | 0.76 | 0.96 | 0.76 | 0.75 | **0.73** | 0.85 | 0.89 | 0.80 | 0.96 |
| hash_chain | 1.23 | 1.13 | 1.13 | 1.14 | 1.20 | 1.22 | 1.18 | 1.20 | 1.12 | 1.23 | **1.10** | 1.16 | 1.18 | 1.15 | 1.23 | 1.90 |
| interp_calc | 1.22 | 0.92 | 0.99 | 1.01 | 0.84 | 0.87 | 0.99 | 0.95 | 0.98 | 0.90 | 0.86 | **0.83** | 0.97 | 0.97 | 0.93 | 1.09 |
| life | 1.40 | 1.37 | 1.37 | 1.37 | 1.31 | 1.30 | 1.31 | 1.32 | 1.31 | **1.30** | 1.35 | 1.35 | 1.33 | 1.36 | 1.33 | — |
| list_alloc | 1.20 | 0.79 | 0.86 | 0.87 | 0.71 | 0.71 | 0.84 | **0.68** | 0.88 | 0.71 | 0.72 | 0.69 | 0.83 | 0.81 | 0.81 | 0.91 |
| list_sort | 1.21 | 1.21 | 1.27 | 1.29 | 1.07 | 1.03 | 1.07 | 1.05 | 1.17 | 1.06 | **1.01** | 1.06 | 1.32 | 1.28 | 1.21 | 1.14 |
| nqueens | 0.98 | 0.96 | 0.98 | 0.98 | 0.98 | 0.94 | 0.95 | 0.98 | 0.95 | 0.95 | **0.93** | 0.96 | 0.98 | 1.01 | 1.01 | 1.01 |
| remset_pressure | 0.47 | 0.34 | 0.36 | 0.39 | 0.36 | 0.31 | 0.37 | **0.29** | 0.37 | 0.31 | 0.32 | 0.30 | 0.35 | 0.34 | 0.34 | 0.48 |
| sieve | **1.24** | 1.36 | 1.48 | 1.43 | 1.63 | 1.42 | 1.62 | 1.44 | 1.52 | 1.48 | 1.52 | 1.34 | 1.45 | 1.52 | 1.54 | 1.40 |
| string_concat | 0.42 | 0.25 | 0.27 | 0.29 | 0.22 | 0.20 | 0.27 | **0.20** | 0.28 | 0.20 | 0.21 | 0.20 | 0.25 | 0.26 | 0.23 | 0.30 |
| string_concat_dyn | 1.67 | 1.03 | 1.17 | 1.20 | 0.98 | **0.92** | 1.14 | 0.94 | 1.23 | 0.95 | 0.97 | 0.94 | 1.05 | 1.05 | 0.99 | 1.30 |
| substr_churn | 1.18 | 0.87 | 0.89 | 0.96 | 0.87 | 0.78 | 0.95 | 0.80 | 1.00 | **0.75** | 0.85 | 0.80 | 0.83 | 0.85 | 0.82 | 1.14 |
| tokenize | 1.53 | 0.88 | 0.97 | 1.05 | 0.79 | **0.74** | 1.00 | 0.75 | 1.08 | 0.84 | 0.78 | 0.77 | 0.92 | 0.94 | 0.85 | 1.14 |
