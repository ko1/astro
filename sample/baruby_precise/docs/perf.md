...
### iter 61 fp 引数削除 (2026-05-21、 `ruby bench/matrix.rb --mode {plain,aot} -n 3`)
...
oracle: 15 backend × 35 bench × `-n 3` で **0 FAIL / 0 FATAL** 完走 (plain + AOT
両方)。 ベンチ結果完全 matrix は [bench-results/](../bench-results/) 参照。

実装詳細は [done.md (61)](done.md)。

#### Plain mode matrix (iter 61, median of 3, 15 backend × 35 bench)

| Bench | none | mark | mark_gen | mark_gen_inc | copy | copy_gen | mark_compact | mark_compact_gen | bump | mark_bump_gen | immix | immix_gen | mark_bitmap_gen | mark_card_gen | mark_freelist | libgc¹ |
|---|---:|---:|---:|---:|---:|---:|---:|---:|---:|---:|---:|---:|---:|---:|---:|---:|
| ackermann | 6.94 | 7.00 | 6.98 | 6.93 | 7.05 | 6.85 | 6.95 | **6.70** | 7.41 | 6.89 | 7.50 | 7.00 | 7.15 | 6.99 | 7.14 | — |
| ast_eval | 0.30 | 0.32 | 0.30 | 0.30 | 0.30 | 0.32 | 0.31 | 0.30 | 0.30 | 0.31 | 0.31 | 0.31 | 0.30 | 0.31 | 0.30 | **0.29** |
| binary_trees | 0.54 | 0.65 | 0.74 | 0.74 | 0.70 | 0.66 | 0.71 | 0.63 | **0.40** | 0.81 | 0.47 | 0.66 | 0.83 | 0.83 | 0.74 | 0.69 |
| branch_dom | 1.77 | 1.78 | 1.76 | 1.77 | 1.77 | 1.78 | 1.83 | 1.82 | 1.77 | 1.81 | 1.83 | 1.78 | 1.81 | 1.76 | **1.75** | — |
| call | 8.06 | 8.49 | 8.08 | 7.65 | 7.62 | 8.74 | **7.44** | 7.65 | 7.83 | 7.87 | 7.89 | 7.72 | 7.63 | 8.02 | 7.47 | — |
| chain20 | 7.37 | 7.48 | 7.30 | 6.99 | 7.08 | 7.34 | **6.60** | 7.28 | 6.84 | 7.30 | 7.52 | 7.33 | 7.29 | 7.62 | 7.21 | — |
| chain40 | 7.97 | 8.06 | 7.88 | 7.55 | 7.09 | 7.95 | 7.44 | 7.34 | **7.06** | 7.29 | 7.71 | 7.12 | 7.79 | 7.24 | 7.54 | — |
| chain_add | 1.03 | 1.05 | 0.97 | 0.95 | 0.96 | 0.98 | 0.95 | 1.00 | 1.04 | 0.96 | 1.05 | 0.99 | 1.11 | 0.96 | **0.93** | — |
| collatz | 4.68 | 5.12 | 4.98 | 4.75 | **4.51** | 5.05 | 5.24 | 4.76 | 5.13 | 4.52 | 4.74 | 4.71 | 5.04 | 5.00 | 4.66 | — |
| compose | 1.30 | 1.28 | 1.41 | 1.27 | 1.25 | 1.38 | 1.28 | 1.29 | 1.24 | 1.30 | 1.31 | 1.27 | 1.36 | 1.36 | **1.21** | — |
| cons_list | 0.96 | 0.66 | 0.74 | 0.80 | 0.58 | 0.63 | 0.74 | 0.64 | 0.75 | 0.64 | 0.60 | **0.58** | 0.73 | 0.75 | 0.64 | 0.70 |
| deep_const | 3.86 | 3.75 | 3.87 | 4.24 | 3.72 | 3.74 | 4.36 | **3.63** | 4.23 | 3.75 | 3.85 | 4.13 | 3.76 | 3.85 | 4.16 | — |
| dll_walk | 0.82 | 0.62 | 0.70 | 0.74 | 0.60 | 0.63 | 0.72 | 0.64 | 0.71 | 0.65 | 0.60 | **0.58** | 0.69 | 0.69 | 0.63 | 0.68 |
| early_return | 5.81 | 5.48 | 5.46 | 5.44 | **5.21** | 5.84 | 5.43 | 5.36 | 5.25 | 5.60 | 5.74 | 5.77 | 5.54 | 5.81 | 5.52 | — |
| fannkuch | 0.62 | 0.65 | 0.65 | 0.67 | 0.62 | 0.59 | 0.64 | 0.59 | 0.62 | 0.60 | 0.64 | 0.60 | 0.67 | 0.69 | 0.62 | **0.57** |
| fib | 5.83 | 5.84 | 5.95 | 5.89 | 5.78 | 5.93 | 5.84 | 5.94 | **5.60** | 5.95 | 5.94 | 5.90 | 5.81 | 5.84 | 5.77 | — |
| fib_pair | 1.22 | 0.74 | 0.86 | 0.88 | 0.63 | 0.69 | 0.80 | 0.69 | 0.86 | 0.69 | 0.67 | **0.60** | 0.78 | 0.79 | 0.68 | 0.85 |
| gc_combined | 1.10 | 0.73 | 0.73 | 0.79 | 0.63 | 0.66 | 0.80 | 0.67 | 0.86 | 0.66 | 0.65 | **0.61** | 0.75 | 0.73 | 0.72 | 0.75 |
| gcd | 3.99 | 4.09 | 3.97 | 4.06 | **3.95** | 4.10 | 4.01 | 4.16 | 4.00 | 4.17 | 4.01 | 4.08 | 4.21 | 3.99 | 3.97 | — |
| hash_chain | 1.07 | 0.98 | 0.96 | 0.92 | 1.04 | 1.00 | **0.88** | 1.09 | 1.01 | 1.07 | 1.03 | 1.07 | 0.96 | 1.00 | 1.09 | 1.06 |
| interp_calc | 1.05 | 0.80 | 0.84 | 0.87 | 0.74 | 0.78 | 0.88 | 0.83 | 0.90 | 0.77 | 0.75 | **0.72** | 0.81 | 0.84 | 0.77 | 0.80 |
| json_parse | 1.47 | 0.81 | 0.89 | 0.94 | 0.72 | 0.70 | 0.93 | **0.68** | 1.08 | 0.68 | 0.74 | 0.69 | 0.84 | 0.80 | 0.75 | 0.95 |
| life | 1.15 | 1.27 | 1.17 | 1.17 | 1.20 | 1.16 | 1.18 | **1.11** | 1.18 | 1.11 | 1.17 | 1.16 | 1.22 | 1.22 | 1.16 | — |
| list_alloc | 1.02 | 0.70 | 0.75 | 0.79 | 0.59 | 0.62 | 0.76 | 0.65 | 0.81 | 0.63 | 0.61 | **0.58** | 0.71 | 0.69 | 0.68 | 0.74 |
| list_sort | 1.05 | 1.06 | 1.09 | 1.11 | 0.97 | **0.89** | 1.02 | 0.95 | 1.04 | 0.92 | 0.92 | 0.93 | 1.17 | 1.14 | 1.09 | 0.95 |
| loop | 1.26 | 1.30 | 1.28 | 1.24 | 1.26 | 1.24 | 1.28 | 1.27 | 1.26 | 1.24 | 1.25 | **1.23** | 1.29 | 1.27 | 1.28 | — |
| nqueens | 0.80 | 0.86 | 0.84 | 0.84 | 0.83 | 0.81 | 0.78 | **0.78** | 0.82 | 0.85 | 0.83 | 0.80 | 0.85 | 0.85 | 0.81 | 0.78 |
| prime_count | 18.87 | 19.39 | 18.82 | 19.00 | 18.63 | 19.35 | 19.43 | 18.21 | 18.48 | **18.12** | 18.98 | 19.72 | 18.63 | 19.45 | 18.91 | — |
| remset_pressure | 0.43 | 0.30 | 0.32 | 0.34 | 0.33 | **0.25** | 0.35 | 0.27 | 0.35 | 0.26 | 0.29 | 0.26 | 0.31 | 0.32 | 0.30 | 0.35 |
| sieve | 1.03 | 1.18 | 1.21 | 1.22 | 1.21 | 1.18 | 1.36 | 1.20 | 1.23 | 1.21 | 1.20 | 1.13 | 1.22 | 1.26 | 1.24 | 1.11 |
| string_concat | 0.37 | 0.22 | 0.24 | 0.24 | 0.19 | 0.17 | 0.25 | 0.17 | 0.25 | 0.18 | 0.18 | **0.16** | 0.23 | 0.22 | 0.21 | 0.24 |
| string_concat_dyn | 1.49 | 0.88 | 0.97 | 1.00 | 0.80 | 0.80 | 1.02 | 0.79 | 1.11 | 0.80 | 0.87 | **0.78** | 0.90 | 0.88 | 0.84 | 1.05 |
| substr_churn | 1.08 | 0.70 | 0.75 | 0.78 | 0.73 | 0.68 | 0.84 | **0.67** | 0.82 | 0.67 | 0.72 | 0.68 | 0.71 | 0.73 | 0.74 | 0.90 |
| tak | 0.71 | 0.71 | 0.72 | 0.70 | 0.70 | **0.70** | 0.71 | 0.71 | 0.72 | 0.74 | 0.72 | 0.73 | 0.70 | 0.70 | 0.71 | — |
| tokenize | 1.34 | 0.76 | 0.80 | 0.90 | 0.65 | **0.64** | 0.90 | 0.64 | 0.97 | 0.64 | 0.69 | 0.65 | 0.78 | 0.77 | 0.72 | 0.90 |

¹ libgc = `sample/baruby` (conservative scanning + libgc + 同言語サブセット)、
plain mode、 同 19 bench (life / branch_dom / call / chain20 等は baruby 側に未移植)。

#### AOT mode matrix (iter 61, median of 3, 15 backend × 35 bench)

| Bench | none | mark | mark_gen | mark_gen_inc | copy | copy_gen | mark_compact | mark_compact_gen | bump | mark_bump_gen | immix | immix_gen | mark_bitmap_gen | mark_card_gen | mark_freelist | libgc¹ |
|---|---:|---:|---:|---:|---:|---:|---:|---:|---:|---:|---:|---:|---:|---:|---:|---:|
| ackermann | 1.26 | 1.26 | 1.25 | 1.26 | 1.26 | 1.26 | **1.25** | 1.25 | 1.26 | 1.27 | 1.28 | 1.27 | 1.27 | 1.25 | 1.27 | — |
| ast_eval | 0.06 | 0.06 | 0.06 | 0.06 | 0.06 | 0.06 | 0.06 | 0.06 | 0.05 | 0.06 | 0.05 | **0.05** | 0.06 | 0.06 | 0.05 | 0.06 |
| binary_trees | 0.37 | 0.46 | 0.51 | 0.54 | 0.49 | 0.45 | 0.48 | 0.44 | **0.21** | 0.64 | 0.28 | 0.45 | 0.62 | 0.63 | 0.46 | 0.44 |
| branch_dom | 0.20 | 0.20 | 0.20 | 0.20 | 0.20 | 0.20 | 0.20 | 0.21 | 0.20 | 0.21 | 0.20 | 0.20 | 0.20 | 0.20 | 0.20 | — |
| call | 1.53 | 1.50 | 1.54 | 1.52 | 1.54 | 1.53 | **1.50** | 1.51 | 1.50 | 1.51 | 1.51 | 1.57 | 1.51 | 1.55 | 1.54 | — |
| chain20 | 1.65 | 1.63 | 1.63 | 1.67 | 1.67 | **1.62** | 1.67 | 1.62 | 1.63 | 1.67 | 1.63 | 1.67 | 1.63 | 1.64 | 1.70 | — |
| chain40 | **2.64** | 2.72 | 2.66 | 2.66 | 2.66 | 2.70 | 2.66 | 2.74 | 2.66 | 2.67 | 2.73 | 2.67 | 2.66 | 2.74 | 2.66 | — |
| chain_add | **0.28** | 0.29 | 0.28 | 0.29 | 0.29 | 0.30 | 0.29 | 0.29 | 0.30 | 0.29 | 0.29 | 0.29 | 0.29 | 0.29 | 0.30 | — |
| collatz | 0.32 | **0.32** | 0.32 | 0.32 | 0.33 | 0.33 | 0.33 | 0.33 | 0.33 | 0.33 | 0.33 | 0.32 | 0.32 | 0.32 | 0.33 | — |
| compose | 0.23 | 0.23 | 0.23 | 0.24 | 0.23 | **0.23** | 0.24 | 0.24 | 0.24 | 0.23 | 0.24 | 0.24 | 0.24 | 0.24 | 0.23 | — |
| cons_list | 0.54 | 0.23 | 0.29 | 0.33 | 0.17 | 0.18 | 0.30 | 0.18 | 0.32 | 0.20 | 0.19 | **0.15** | 0.29 | 0.29 | 0.20 | 0.31 |
| deep_const | 1.24 | **1.20** | 1.24 | 1.20 | 1.25 | 1.21 | 1.21 | 1.25 | 1.25 | 1.21 | 1.24 | 1.25 | 1.22 | 1.23 | 1.25 | — |
| dll_walk | 0.34 | 0.16 | 0.21 | 0.24 | 0.13 | 0.15 | 0.21 | 0.15 | 0.23 | 0.16 | 0.14 | **0.12** | 0.22 | 0.22 | 0.15 | 0.25 |
| early_return | 0.32 | 0.32 | 0.32 | 0.32 | 0.31 | 0.32 | 0.32 | 0.33 | 0.32 | 0.32 | 0.32 | 0.32 | **0.31** | 0.31 | 0.32 | — |
| fannkuch | 0.11 | 0.12 | 0.14 | 0.14 | 0.16 | **0.10** | 0.15 | 0.11 | 0.14 | 0.11 | 0.12 | 0.13 | 0.16 | 0.15 | 0.14 | 0.10 |
| fib | 1.17 | 1.11 | 1.16 | 1.15 | 1.13 | 1.12 | **1.11** | 1.15 | 1.22 | 1.16 | 1.14 | 1.13 | 1.12 | 1.11 | 1.18 | — |
| fib_pair | 0.78 | 0.33 | 0.39 | 0.45 | 0.24 | 0.24 | 0.41 | 0.24 | 0.46 | 0.25 | 0.26 | **0.22** | 0.38 | 0.37 | 0.29 | 0.48 |
| gc_combined | 0.60 | 0.27 | 0.31 | 0.34 | 0.21 | **0.17** | 0.35 | 0.17 | 0.45 | 0.18 | 0.22 | 0.18 | 0.30 | 0.30 | 0.28 | 0.34 |
| gcd | 0.35 | 0.36 | 0.35 | 0.36 | 0.35 | 0.35 | 0.35 | 0.35 | 0.35 | 0.34 | **0.34** | 0.35 | 0.35 | 0.34 | 0.35 | — |
| hash_chain | 0.14 | 0.15 | 0.14 | 0.15 | 0.15 | 0.15 | 0.16 | 0.16 | **0.13** | 0.16 | 0.13 | 0.13 | 0.15 | 0.15 | 0.17 | 0.16 |
| interp_calc | 0.52 | 0.25 | 0.31 | 0.34 | 0.21 | 0.22 | 0.34 | 0.22 | 0.36 | 0.24 | 0.22 | **0.19** | 0.31 | 0.31 | 0.25 | 0.35 |
| json_parse | 1.01 | 0.39 | 0.48 | 0.58 | 0.35 | 0.32 | 0.56 | 0.34 | 0.66 | 0.34 | 0.38 | **0.32** | 0.42 | 0.43 | 0.38 | 0.59 |
| life | 0.13 | 0.15 | 0.16 | 0.16 | 0.14 | 0.13 | **0.13** | 0.13 | 0.14 | 0.14 | 0.13 | 0.13 | 0.16 | 0.16 | 0.15 | — |
| list_alloc | 0.62 | 0.26 | 0.30 | 0.34 | 0.18 | 0.17 | 0.31 | **0.16** | 0.39 | 0.17 | 0.18 | 0.17 | 0.29 | 0.29 | 0.24 | 0.34 |
| list_sort | 0.31 | 0.32 | 0.36 | 0.37 | 0.20 | 0.20 | 0.23 | 0.19 | 0.30 | 0.20 | 0.20 | **0.18** | 0.39 | 0.38 | 0.33 | 0.23 |
| loop | 0.10 | 0.09 | 0.09 | 0.10 | 0.09 | 0.10 | 0.09 | 0.09 | 0.09 | 0.10 | 0.09 | **0.09** | 0.10 | 0.09 | 0.09 | — |
| nqueens | 0.08 | 0.08 | 0.09 | 0.09 | 0.08 | 0.07 | 0.08 | 0.07 | 0.07 | 0.07 | 0.07 | **0.07** | 0.09 | 0.09 | 0.08 | 0.06 |
| prime_count | 0.51 | **0.51** | 0.53 | 0.53 | 0.52 | 0.52 | 0.52 | 0.53 | 0.52 | 0.53 | 0.52 | 0.53 | 0.52 | 0.52 | 0.53 | — |
| remset_pressure | 0.23 | 0.12 | 0.12 | 0.14 | 0.12 | 0.07 | 0.16 | **0.07** | 0.14 | 0.08 | 0.10 | 0.07 | 0.11 | 0.11 | 0.10 | 0.18 |
| sieve | **0.23** | 0.36 | 0.40 | 0.40 | 0.75 | 0.39 | 0.70 | 0.40 | 0.64 | 0.38 | 0.69 | 0.35 | 0.40 | 0.41 | 0.66 | 0.31 |
| string_concat | 0.26 | 0.10 | 0.12 | 0.14 | 0.08 | **0.06** | 0.14 | 0.07 | 0.14 | 0.07 | 0.08 | 0.06 | 0.11 | 0.11 | 0.10 | 0.14 |
| string_concat_dyn | 0.89 | 0.36 | 0.42 | 0.51 | 0.28 | 0.26 | 0.50 | 0.28 | 0.57 | 0.28 | 0.32 | **0.26** | 0.37 | 0.38 | 0.32 | 0.56 |
| substr_churn | 0.59 | 0.27 | 0.28 | 0.33 | 0.33 | 0.19 | 0.41 | 0.19 | 0.45 | **0.18** | 0.28 | 0.25 | 0.25 | 0.25 | 0.31 | 0.41 |
| tak | 0.17 | 0.17 | 0.17 | 0.17 | 0.17 | 0.18 | 0.17 | 0.17 | 0.17 | 0.19 | 0.17 | **0.16** | 0.18 | 0.16 | 0.17 | — |
| tokenize | 0.99 | 0.38 | 0.46 | 0.57 | 0.31 | 0.29 | 0.56 | 0.29 | 0.61 | 0.31 | 0.35 | **0.29** | 0.40 | 0.40 | 0.36 | 0.58 |

¹ libgc = `sample/baruby`、 AOT mode、 同 19 bench。 baruby は専用 cwd
(`sample/baruby/`) で計測 (baruby_precise の cwd で走らせると `code_store/`
が衝突するため。 matrix.rb --libgc-bin 経由は plain のみ安全)。

#### 勝者分布 (iter 61 plain + AOT、 baruby_precise 内 15 backend)

**plain (35 bench)**:
- `immix_gen`: 9 wins (cons_list / dll_walk / fib_pair / gc_combined / interp_calc / list_alloc / loop / string_concat / string_concat_dyn)
- `copy_gen`: 4 wins (fannkuch / list_sort / remset_pressure / tak)
- `mark_compact_gen`: 4 wins (deep_const / json_parse / life / nqueens / substr_churn)
- `none`: 2 wins (ast_eval tied / sieve)
- `mark_bump_gen`: 2 wins (json_parse 同位 / prime_count)
- `mark_compact`: 2 wins (call / chain20)
- `bump`: 2 wins (binary_trees / fib / chain40)
- `mark_freelist`: 2 wins (branch_dom / chain_add / compose)
- `copy`: 2 wins (collatz / early_return / gcd)
- 他は各 1 win 以内

`immix_gen` 優勢は iter 58 から継続。 fp 削除で全 backend が一律 -25〜-40%
シフトしただけで列ごとの順位はほぼ不変。

**AOT (35 bench)**:
- `immix_gen`: 13 wins (ast_eval / cons_list / dll_walk / fib_pair / gcd / interp_calc /
  json_parse / list_sort / loop / nqueens / string_concat_dyn / substr_churn 同位 /
  tokenize、 + tak)
- `copy_gen`: 3 wins (compose / fannkuch / gc_combined / string_concat)
- `mark_compact`: 3 wins (ackermann 同位 / call / fib)
- `bump`: 2 wins (binary_trees / hash_chain)
- `mark_compact_gen`: 2 wins (life / list_alloc / remset_pressure)
- `none`: 1 win (chain40 / chain_add 同位 / sieve)
- 他は各 1 win 以内

AOT で `immix_gen` がさらに支配的になる。 dispatcher が dlopen 越し inline
される世界では nursery alloc cost の差がより visible。

#### vs iter 59 AOT (copy backend、 fp 削除効果)

| bench | iter 59 | iter 61 | Δ |
|---|---:|---:|---:|
| ackermann | 1.49 | 1.26 | **-15%** |
| call | 3.22 | 1.54 | **-52%** |
| chain20 | 3.43 | 1.67 | **-51%** |
| chain40 | 4.57 | 2.66 | **-42%** |
| chain_add | 0.48 | 0.29 | **-40%** |
| collatz | 0.70 | 0.33 | **-53%** |
| compose | 0.39 | 0.23 | **-41%** |
| deep_const | 1.73 | 1.25 | **-28%** |
| early_return | 1.01 | 0.31 | **-69%** |
| fannkuch | 0.26 | 0.16 | **-38%** |
| fib | 1.83 | 1.13 | **-38%** |
| gcd | 0.81 | 0.35 | **-57%** |
| hash_chain | 0.30 | 0.15 | **-50%** |
| interp_calc | 0.28 | 0.21 | **-25%** |
| json_parse | 0.46 | 0.35 | **-24%** |
| life | 0.25 | 0.14 | **-44%** |
| list_alloc | 0.25 | 0.18 | **-28%** |
| list_sort | 0.31 | 0.20 | **-35%** |
| loop | 0.22 | 0.09 | **-59%** |
| nqueens | 0.17 | 0.08 | **-53%** |
| **prime_count** | **4.67** | **0.52** | **-89%** |
| sieve | 1.00 | 0.75 | -25% |
| string_concat | 0.11 | 0.08 | -27% |
| string_concat_dyn | 0.37 | 0.28 | -24% |
| substr_churn | 0.50 | 0.33 | -34% |
| tak | 0.26 | 0.17 | -35% |
| tokenize | 0.42 | 0.31 | -26% |

最大は **prime_count -89%** (4.67 → 0.52s)。 inner loop が trial-division
で dispatcher heavy、 GC pressure ゼロ。 fp register 開放 + arg shuffle 削減
が直接効いた典型例。 逆に GC-bound bench (binary_trees / cons_list /
list_alloc / fib_pair 等) は **-22〜-36%** で、 dispatcher overhead 比率の
差がそのまま改善幅に出ている。 geomean ≈ **-37%**。

#### vs libgc (baruby、 共通 19 bench)

baruby_precise (precise + moving GC、 sp[] stack 走査) vs baruby (conservative
+ libgc、 C スタック走査) の同言語ランナーで比較。 列は baruby_precise の
**ベスト backend**。

| bench | precise plain (best) | libgc plain | precise/libgc | precise AOT (best) | libgc AOT | precise/libgc |
|---|---:|---:|---:|---:|---:|---:|
| ast_eval | 0.30 | 0.29 | 1.03× | 0.05 | 0.06 | **0.83×** |
| binary_trees | 0.40 | 0.69 | **0.58×** | 0.21 | 0.44 | **0.48×** |
| cons_list | 0.58 | 0.70 | **0.83×** | 0.15 | 0.31 | **0.48×** |
| dll_walk | 0.58 | 0.68 | **0.85×** | 0.12 | 0.25 | **0.48×** |
| fannkuch | 0.59 | 0.57 | 1.03× | 0.10 | 0.10 | 1.04× |
| fib_pair | 0.60 | 0.85 | **0.71×** | 0.22 | 0.48 | **0.46×** |
| gc_combined | 0.61 | 0.75 | **0.81×** | 0.17 | 0.34 | **0.50×** |
| hash_chain | 0.88 | 1.06 | **0.83×** | 0.13 | 0.16 | **0.81×** |
| interp_calc | 0.72 | 0.80 | **0.91×** | 0.19 | 0.35 | **0.54×** |
| json_parse | 0.68 | 0.95 | **0.72×** | 0.32 | 0.59 | **0.54×** |
| list_alloc | 0.58 | 0.74 | **0.78×** | 0.16 | 0.34 | **0.47×** |
| list_sort | 0.89 | 0.95 | **0.94×** | 0.18 | 0.23 | **0.78×** |
| nqueens | 0.78 | 0.78 | 1.00× | 0.07 | 0.06 | 1.10× |
| remset_pressure | 0.25 | 0.35 | **0.71×** | 0.07 | 0.18 | **0.39×** |
| sieve | 1.03 | 1.11 | **0.93×** | 0.23 | 0.31 | **0.74×** |
| string_concat | 0.16 | 0.24 | **0.67×** | 0.06 | 0.14 | **0.43×** |
| string_concat_dyn | 0.78 | 1.05 | **0.74×** | 0.26 | 0.56 | **0.46×** |
| substr_churn | 0.67 | 0.90 | **0.74×** | 0.18 | 0.41 | **0.44×** |
| tokenize | 0.64 | 0.90 | **0.71×** | 0.29 | 0.58 | **0.50×** |

**結果サマリ**:
- **plain**: baruby_precise が大半で勝つ。 geomean precise/libgc = **0.83×**
  (= precise が 17% 速い)。 conservative scanning による GC pause cost と
  conservative pinning overhead が libgc 側のロスとして表面化している。
  fannkuch / nqueens / ast_eval だけ tied (= int-heavy / 配列軽い bench)。
- **AOT**: baruby_precise が**圧勝**。 geomean precise/libgc = **0.56×**
  (= precise が ~1.8× 速い)。 baruby_precise の AOT が SD chain inline で
  fp 削除後の register saving を活かしているのに対し、 baruby (libgc) の
  AOT は同じ inline 戦略ながら fp 引数を残している (libgc 側未削除) ため
  ベース dispatcher overhead で差。
- 唯一 nqueens AOT で libgc が 0.06 vs precise 0.07 (= +10%)。 nqueens は
  intのみの再帰 + branch、 allocation ゼロ。 ここでは libgc 側の `restrict`
  fp/sp が register pressure を有利にしている可能性。

iter 61 fp 削除のおかげで AOT 比較が **逆転倍率** で広がった (iter 58
時点では libgc も AOT が precise と互角だった bench がいくつかあったが、
fp 削除で precise 側が全面的に引き離した)。 baruby 側にも同じ最適化を
ポートすれば差は再び縮まる見込み (= todo)。

実装詳細は [done.md (61)](done.md)。 完全 matrix は
[bench-results/iter61_plain.md / iter61_aot.md](../bench-results/) 参照。
