...
|---|---:|---:|---:|---:|---:|---:|---:|---:|---:|---:|---:|---:|---:|---:|---:|
| ast_eval | 0.37 | 0.34 | 0.34 | **0.33** | 0.35 | 0.36 | 0.38 | 0.34 | 0.35 | 0.36 | 0.35 | 0.35 | 0.36 | 0.36 | 0.38 |
| binary_trees | 0.73 | 0.75 | 0.82 | 0.81 | 0.75 | 0.70 | 0.77 | 0.70 | **0.43** | 0.86 | 0.51 | 0.76 | 0.94 | 0.91 | 0.80 |
| cons_list | 1.09 | 0.78 | 0.86 | 0.91 | **0.68** | 0.73 | 0.81 | 0.73 | 0.81 | 0.77 | 0.69 | 0.68 | 0.85 | 0.84 | 0.90 |
| fannkuch | 0.69 | 0.73 | 0.73 | 0.75 | 0.70 | **0.68** | 0.70 | 0.69 | 0.71 | 0.73 | 0.71 | 0.73 | 0.77 | 0.75 | 0.73 |
| fib_pair | 1.35 | 0.86 | 0.97 | 1.02 | 0.75 | 0.78 | 0.92 | 0.80 | 0.95 | 0.81 | 0.76 | **0.74** | 0.90 | 0.94 | 1.03 |
| gc_combined | 1.20 | 0.84 | 0.88 | 0.89 | **0.69** | 0.73 | 0.85 | 0.72 | 0.94 | 0.77 | 0.76 | 0.72 | 0.84 | 0.89 | 0.89 |
| hash_chain | 1.25 | 1.15 | 1.11 | **1.10** | 1.20 | 1.15 | 1.19 | 1.20 | 1.11 | 1.22 | 1.12 | 1.12 | 1.13 | 1.15 | 1.39 |
| interp_calc | 1.19 | 0.89 | 0.98 | 1.01 | **0.82** | 0.86 | 0.99 | 0.89 | 0.97 | 0.90 | 0.84 | 0.83 | 0.96 | 0.97 | 1.01 |
| life | **1.26** | 1.28 | 1.30 | 1.32 | 1.29 | 1.30 | 1.27 | 1.27 | 1.29 | 1.34 | 1.32 | 1.29 | 1.31 | 1.31 | — |
| list_alloc | 1.13 | 0.76 | 0.87 | 0.90 | **0.66** | 0.70 | 0.81 | 0.73 | 0.92 | 0.69 | 0.71 | 0.69 | 0.83 | 0.80 | 0.91 |
| list_sort | 1.14 | 1.17 | 1.21 | 1.24 | **1.01** | 1.01 | 1.11 | 1.06 | 1.17 | 1.05 | 1.04 | 1.04 | 1.28 | 1.25 | 1.12 |
| nqueens | 0.92 | 0.94 | 0.94 | 0.97 | 0.94 | **0.91** | 0.93 | 0.94 | 0.94 | 0.92 | 0.95 | 0.93 | 0.98 | 0.96 | 0.96 |
| remset_pressure | 0.46 | 0.37 | 0.37 | 0.36 | 0.36 | 0.30 | 0.39 | 0.30 | 0.38 | 0.31 | 0.33 | **0.30** | 0.36 | 0.34 | 0.45 |
| sieve | **1.23** | 1.34 | 1.36 | 1.39 | 1.61 | 1.42 | 1.60 | 1.38 | 1.58 | 1.46 | 1.51 | 1.29 | 1.44 | 1.54 | 1.36 |
| string_concat | 0.40 | 0.25 | 0.26 | 0.28 | 0.21 | 0.21 | 0.28 | 0.21 | 0.27 | 0.21 | 0.22 | **0.20** | 0.26 | 0.25 | 0.29 |
| string_concat_dyn | 2.18 | 1.26 | 1.30 | 1.41 | **1.02** | 1.08 | 1.34 | 1.10 | 1.36 | 1.13 | 1.07 | 1.04 | 1.30 | 1.26 | 1.48 |
| substr_churn | 1.62 | 1.04 | 1.10 | 1.10 | 0.91 | 0.92 | 1.09 | **0.85** | 1.11 | 0.91 | 0.92 | 0.88 | 1.06 | 1.05 | 1.28 |

**勝者分布** (plain, iter 38 v2、 median of 3):
- `copy` — **5 wins** (cons_list / gc_combined / interp_calc / list_alloc /
  list_sort tied / string_concat_dyn) — pure semispace Cheney が tight
  contest を多数獲得
- `immix_gen` — **3 wins** (fib_pair / remset_pressure / string_concat)
- `none` — **2 wins** (life / sieve) — GC を全く走らせない floor
- `copy_gen` — **2 wins** (fannkuch / nqueens)
- `mark_gen_inc` — **2 wins** (ast_eval / hash_chain) — SATB barrier の
  overhead はあるものの tight な non-gen workload で僅差勝ち
- `bump` — **1 win** (binary_trees 0.43) — alloc-only floor
- `mark_compact_gen` — **1 win** (substr_churn)
- `copy` 1 同位 (list_sort 1.01 vs copy_gen 1.01)
- 全体として **iter 38 v2 で「勝者の多様化」** が起きた: iter 37 の
  immix_gen 11/17 一強 → iter 38 v2 では 8 backend が勝者に。 これは
  v2 で immix_gen 自体が perf 回復した上で、 system noise + system が
  若干高速化したことで copy/copy_gen の tight contest が転んだ結果。
  immix_gen は依然 string-heavy / sparse-write 系では強い

### AOT mode matrix (iter 38 v2, `ruby bench/matrix.rb --mode aot`)

| Bench | none | mark | mark_gen | mark_gen_inc | copy | copy_gen | mark_compact | mark_compact_gen | bump | mark_bump_gen | immix | immix_gen | mark_bitmap_gen | mark_card_gen | libgc |
|---|---:|---:|---:|---:|---:|---:|---:|---:|---:|---:|---:|---:|---:|---:|---:|
| ast_eval | 0.06 | 0.06 | 0.06 | 0.06 | 0.06 | 0.06 | 0.07 | 0.07 | 0.06 | 0.07 | 0.06 | **0.06** | 0.06 | 0.06 | 0.35 |
| binary_trees | 0.40 | 0.49 | 0.54 | 0.56 | 0.52 | 0.48 | 0.50 | 0.48 | **0.21** | 0.58 | 0.29 | 0.48 | 0.67 | 0.66 | 0.78 |
| cons_list | 0.59 | 0.28 | 0.34 | 0.39 | 0.20 | 0.24 | 0.33 | 0.24 | 0.35 | 0.21 | 0.20 | **0.19** | 0.35 | 0.33 | 0.88 |
| fannkuch | 0.70 | 0.73 | 0.14 | 0.15 | 0.70 | 0.12 | 0.72 | 0.12 | 0.74 | **0.12** | 0.70 | 0.12 | 0.17 | 0.15 | 0.71 |
| fib_pair | 0.82 | 0.38 | 0.44 | 0.50 | 0.28 | 0.30 | 0.45 | 0.30 | 0.50 | 0.28 | 0.27 | **0.25** | 0.43 | 0.41 | 1.01 |
| gc_combined | 0.66 | 0.32 | 0.34 | 0.39 | 0.21 | 0.22 | 0.35 | 0.22 | 0.43 | 0.20 | 0.20 | **0.19** | 0.34 | 0.33 | 0.88 |
| hash_chain | 1.13 | 1.16 | 0.16 | 0.16 | 1.26 | 0.18 | 1.22 | 0.17 | 1.10 | 0.18 | 1.13 | **0.15** | 0.16 | 0.18 | 1.41 |
| interp_calc | 0.55 | 0.30 | 0.34 | 0.38 | **0.23** | 0.27 | 0.38 | 0.28 | 0.38 | 0.27 | 0.23 | 0.23 | 0.36 | 0.35 | 0.96 |
| life | 0.14 | 0.17 | 0.16 | 0.16 | 0.15 | 0.15 | 0.15 | 0.14 | 0.15 | 0.15 | **0.14** | 0.14 | 0.17 | 0.18 | — |
| list_alloc | 0.65 | 0.32 | 0.33 | 0.39 | 0.19 | 0.21 | 0.34 | 0.21 | 0.42 | 0.19 | 0.19 | **0.18** | 0.34 | 0.33 | 0.87 |
| list_sort | 0.32 | 0.35 | 0.38 | 0.40 | 0.22 | 0.22 | 0.27 | 0.22 | 0.33 | 0.22 | 0.22 | **0.20** | 0.42 | 0.42 | 1.07 |
| nqueens | 0.08 | 0.09 | 0.09 | 0.09 | 0.08 | 0.07 | 0.08 | 0.08 | 0.08 | 0.07 | 0.07 | **0.07** | 0.09 | 0.09 | 0.89 |
| remset_pressure | 0.46 | 0.37 | 0.15 | 0.16 | 0.37 | **0.08** | 0.40 | 0.09 | 0.38 | 0.09 | 0.32 | 0.10 | 0.14 | 0.14 | 0.45 |
| sieve | 1.21 | 1.31 | 0.41 | 0.42 | 1.66 | 0.42 | 1.59 | 0.43 | 1.51 | 0.41 | 1.58 | **0.36** | 0.47 | 0.46 | 1.31 |
| string_concat | 0.28 | 0.13 | 0.14 | 0.16 | 0.09 | 0.08 | 0.15 | 0.09 | 0.15 | 0.08 | 0.08 | **0.07** | 0.14 | 0.13 | 0.28 |
| string_concat_dyn | 1.48 | 0.61 | 0.70 | 0.77 | **0.39** | 0.44 | 0.74 | 0.43 | 0.74 | 0.42 | 0.42 | 0.39 | 0.67 | 0.64 | 1.45 |
| substr_churn | 1.06 | 0.49 | 0.51 | 0.56 | 0.42 | 0.32 | 0.67 | 0.32 | 0.75 | 0.31 | 0.54 | **0.30** | 0.48 | 0.47 | 1.30 |

**勝者分布** (AOT, iter 38 v2): immix_gen は AOT で依然 **10 wins** (ast_eval /
cons_list / fib_pair / gc_combined / hash_chain / list_alloc / list_sort /
nqueens / sieve / string_concat / substr_churn) + 4 ties (fannkuch /
interp_calc / life / string_concat_dyn)。 dispatch overhead が SD bake で
消えると line allocator + gen の amortized cost が直に効く。 plain で
copy 系に分散していた wins が AOT で immix_gen に集中するパターンは
iter 37 と同じ。
