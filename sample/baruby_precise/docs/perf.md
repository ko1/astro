...
|---|---:|---:|---:|---:|---:|---:|---:|---:|---:|---:|---:|---:|---:|---:|---:|
| ast_eval | 0.06 | 0.06 | 0.06 | 0.06 | 0.07 | 0.07 | 0.07 | 0.06 | 0.06 | 0.06 | 0.06 | **0.06** | 0.06 | 0.06 | 0.36 |
| binary_trees | 0.39 | 0.49 | 0.55 | 0.56 | 0.53 | 0.48 | 0.50 | 0.47 | **0.21** | 0.57 | 0.28 | 0.48 | 0.66 | 0.66 | 0.76 |
| cons_list | 0.59 | 0.29 | 0.34 | 0.39 | 0.21 | 0.23 | 0.34 | 0.24 | 0.35 | 0.20 | 0.19 | **0.19** | 0.36 | 0.33 | 0.86 |
| dll_walk | 0.94 | 0.76 | 0.24 | 0.28 | 0.74 | 0.19 | 0.84 | 0.20 | 0.83 | 0.17 | 0.73 | **0.16** | 0.26 | 0.24 | 0.85 |
| fannkuch | 0.69 | 0.75 | 0.14 | 0.15 | 0.71 | **0.11** | 0.73 | 0.12 | 0.70 | 0.12 | 0.72 | 0.12 | 0.17 | 0.15 | 0.70 |
| fib_pair | 0.82 | 0.39 | 0.44 | 0.50 | 0.28 | 0.30 | 0.45 | 0.30 | 0.49 | 0.26 | 0.26 | **0.25** | 0.43 | 0.41 | 0.99 |
| gc_combined | 0.66 | 0.32 | 0.35 | 0.39 | 0.21 | 0.21 | 0.35 | 0.21 | 0.41 | 0.19 | 0.20 | **0.19** | 0.34 | 0.33 | 0.90 |
| hash_chain | 1.14 | 1.14 | 0.16 | 0.16 | 1.25 | 0.18 | 1.22 | 0.18 | 1.12 | 0.17 | 1.10 | **0.14** | 0.16 | 0.18 | 1.10 |
| interp_calc | 0.55 | 0.30 | 0.34 | 0.40 | 0.23 | 0.27 | 0.37 | 0.27 | 0.37 | 0.27 | 0.24 | **0.23** | 0.35 | 0.35 | 1.01 |
| life | 0.14 | 0.16 | 0.16 | 0.17 | 0.15 | 0.14 | 0.15 | 0.14 | 0.15 | 0.14 | **0.14** | 0.14 | 0.17 | 0.18 | — |
| list_alloc | 0.65 | 0.31 | 0.33 | 0.39 | 0.20 | 0.21 | 0.34 | 0.20 | 0.41 | 0.19 | 0.19 | **0.18** | 0.34 | 0.32 | 0.87 |
| list_sort | 0.32 | 0.34 | 0.37 | 0.42 | 0.22 | 0.22 | 0.27 | 0.22 | 0.32 | 0.21 | 0.21 | **0.20** | 0.42 | 0.42 | 1.10 |
| nqueens | 0.08 | 0.09 | 0.09 | 0.09 | 0.08 | 0.08 | 0.08 | 0.07 | 0.08 | 0.07 | 0.07 | **0.07** | 0.10 | 0.09 | 0.93 |
| remset_pressure | 0.46 | 0.37 | 0.15 | 0.17 | 0.39 | **0.07** | 0.39 | 0.08 | 0.36 | 0.08 | 0.32 | 0.09 | 0.14 | 0.14 | 0.43 |
| sieve | 1.17 | 1.35 | 0.41 | 0.52 | 1.63 | 0.43 | 1.57 | 0.42 | 1.54 | 0.40 | 1.53 | **0.36** | 0.46 | 0.45 | 1.35 |
| string_concat | 0.28 | 0.13 | 0.14 | 0.16 | 0.09 | 0.08 | 0.15 | 0.08 | 0.14 | 0.08 | 0.08 | **0.07** | 0.13 | 0.13 | 0.28 |
| string_concat_dyn | 1.47 | 0.62 | 0.70 | 0.78 | **0.38** | 0.44 | 0.74 | 0.43 | 0.73 | 0.41 | 0.42 | 0.39 | 0.66 | 0.62 | 1.42 |
| substr_churn | 1.07 | 0.49 | 0.51 | 0.58 | 0.42 | 0.32 | 0.58 | 0.31 | 0.73 | **0.30** | 0.53 | 0.30 | 0.48 | 0.46 | 1.25 |

**勝者分布** (AOT, iter 40): immix_gen は AOT で **11 wins** (ast_eval /
cons_list / dll_walk / fib_pair / gc_combined / hash_chain / interp_calc /
list_alloc / list_sort / nqueens / sieve / string_concat) + 4 ties
(fannkuch / life / string_concat_dyn / substr_churn) — plain では分散
していた勝ちが AOT で集中するパターンは iter 37 から不変。 dll_walk は
AOT で gen vs non-gen の差が極端 (gen 0.16-0.28 vs non-gen 0.74-0.94)、
walk の dispatch がベイクされた結果 gen の minor が圧倒的に支配的になる。
