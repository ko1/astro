...
## 2. 全 GC backend のベンチ実測 (plain mode, 13 bench × 14 構成, 3-run best)

13 種類の自前 backend + 姉妹 `sample/baruby` (Boehm libgc conservative) を
**横並び 14 列**で比較。 ベンチは 13 種、 各 3-run 中の best。 単位: 秒。
...
|---------------| ------: | ------: | ------: | ------: | ------: | ------: | ------: | ------: | ------: | ------: | ------: | ------: | ------: | ------: |
| binary_trees  | 0.64 | 0.92 | 1.21 | 1.27 | 0.53 | 0.80 | 0.79 | 0.60 | 0.81 | **0.49** | 0.90 | 0.68 | 1.15 | 0.88 |
| cons_list     | 1.24 | 0.81 | 0.95 | 1.01 | 1.08 | 0.84 | 0.86 | 1.16 | **0.74** | 0.98 | 0.85 | 0.96 | 0.88 | 0.99 |
| fannkuch      | 0.72 | 0.69 | 0.73 | 0.74 | 0.73 | 0.73 | 0.71 | 0.76 | 0.72 | 0.75 | **0.66** | 0.76 | 0.75 | 0.71 |
| fib_pair      | 1.61 | 0.87 | 1.07 | 1.10 | 1.39 | 0.93 | 0.91 | 1.56 | 0.86 | 1.24 | **0.84** | 1.10 | 1.02 | 1.12 |
| gc_combined   | 1.42 | 0.92 | 1.01 | 1.11 | 1.22 | 1.00 | 0.94 | 1.32 | **0.82** | 1.26 | 0.88 | 1.11 | 1.01 | 1.05 |
| hash_chain    | 1.22 | 2.19 | 2.27 | 2.18 | 1.45 | 1.22 | 1.24 | 1.64 | 1.24 | 1.29 | **1.19** | 1.49 | 1.38 | 1.42 |
| interp_calc   | 1.35 | **0.96** | 1.14 | 1.21 | 1.20 | 1.04 | 1.01 | 1.31 | 1.02 | 1.10 | **0.96** | 1.14 | 1.10 | 1.24 |
| life          | 1.31 | 1.31 | 1.38 | 1.36 | 1.39 | 1.37 | 1.30 | 1.41 | 1.33 | 1.26 | **1.25** | 1.35 | 1.47 | — |
| list_alloc    | 1.34 | 0.82 | 0.92 | 1.06 | 1.18 | 0.91 | 0.87 | 1.29 | **0.78** | 1.11 | 0.84 | 1.03 | 0.96 | 1.05 |
| list_sort     | 1.20 | 1.21 | 1.22 | 1.23 | 1.23 | 1.08 | 1.08 | 1.28 | 1.04 | 1.11 | **1.00** | 1.20 | 1.18 | 1.01 |
| nqueens       | 0.88 | 0.94 | 0.94 | 0.95 | 0.98 | 0.96 | 0.97 | 1.00 | 0.94 | 0.94 | 1.01 | 1.01 | 1.07 | **0.88** |
| string_concat | 1.60 | 0.68 | 0.82 | 0.86 | 0.97 | 0.55 | 0.55 | 1.22 | 0.56 | 0.92 | **0.51** | 0.70 | 0.67 | 0.88 |
| substr_churn  | 1.75 | 1.11 | 1.10 | 1.07 | 1.32 | **0.88** | 0.95 | 1.64 | 0.93 | 1.21 | 0.96 | 0.91 | 1.00 | 1.23 |

**勝者分布** (2026-05-18 (26) refresh、 immix_gen 追加 で 14 構成):
