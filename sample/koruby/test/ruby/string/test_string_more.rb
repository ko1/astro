...
TESTS = [
  :test_center, :test_ljust_rjust, :test_chop, :test_chop_bang,
  :test_count_chars, :test_delete_chars, :test_squeeze, :test_swapcase,
  :test_capitalize, :test_lines, :test_partition, :test_rpartition,
  :test_succ_next, :test_each_byte, :test_ord, :test_intern,
  :test_freeze_str, :test_eql_str, :test_clone_str, :test_count_with_block_str,
  :test_str_compare, :test_format_sprintf,
  :test_sub_block, :test_gsub_block, :test_string_slice_range,
]
