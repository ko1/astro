...
|---|--:|--:|--:|--:|--:|
| ackermann | 1.287 | 0.171 | 0.948 | 1.399 | 0.339 |
| array_access | 1.007 | 0.334 | 0.883 | 1.291 | 0.285 |
| ary | 0.790 | 0.368 | 0.533 | 1.201 | 0.219 |
| aryidx | 0.064 | 0.059 | 0.016 | 1.047 | 0.011 |
| bignum | 0.177 | 0.150 | 0.122 | 1.146 | 0.109 |
| binary_trees | 0.377 | 0.163 | 0.268 | 1.277 | 0.192 |
| bitops | 1.711 | 0.420 | 0.926 | 1.106 | 0.093 |
| block | 0.618 | 0.496 | 0.261 | 1.206 | 0.191 |
| casewhen | 0.488 | 0.177 | 0.513 | 1.186 | 0.139 |
| closures | 0.745 | 0.757 | 0.285 | 1.226 | 0.184 |
| cmpsort | 0.423 | 0.283 | 0.270 | 1.286 | 0.219 |
| collatz | 0.867 | 0.359 | 0.832 | 1.301 | 0.286 |
| exception | 0.284 | 0.285 | 0.116 | 1.079 | 0.056 |
| fannkuch | 0.782 | 0.270 | 0.664 | 1.860 | 0.183 |
| fib | 0.728 | 0.124 | 0.436 | 1.198 | 0.158 |
| floatcalc | 0.617 | 0.255 | 0.424 | 1.324 | 0.255 |
| gc_bigobj | 0.594 | 0.518 | 0.235 | 1.251 | 0.197 |
| gc_wb | 0.261 | 0.268 | 0.172 | 1.245 | 0.091 |
| gcchurn | 0.628 | 0.426 | 0.468 | 1.246 | 0.191 |
| gcd | 1.314 | 0.269 | 0.831 | 1.313 | 0.282 |
| gen_gc | 0.377 | 0.368 | 0.426 | 1.541 | 0.328 |
| hash | 0.882 | 0.549 | 0.744 | 1.499 | 0.455 |
| hashiter | 0.493 | 0.376 | 0.206 | 1.149 | 0.153 |
| intdiv | 0.552 | 0.215 | 0.422 | 1.124 | 0.062 |
| iterators | 1.638 | 1.001 | 0.721 | 1.559 | 0.519 |
| ivar | 1.332 | 0.201 | 0.861 | 1.293 | 0.272 |
| kwargs | 0.573 | 0.200 | 0.376 | 1.153 | 0.138 |
| mandelbrot | 0.971 | 0.364 | 0.939 | 1.715 | 0.363 |
| mapreduce | 1.236 | 0.811 | 0.409 | 1.345 | 0.322 |
| mathfn | 0.411 | 0.243 | 0.364 | 1.311 | 0.238 |
| method_call | 1.492 | 0.253 | 0.928 | 1.289 | 0.297 |
| methodchain | 0.975 | 0.661 | 0.420 | 1.389 | 0.362 |
| nbody | 0.658 | 0.231 | 0.450 | 3.339 | 0.354 |
| nested_loop | 1.095 | 0.131 | 0.906 | 1.119 | 0.090 |
| nesteddata | 0.151 | 0.140 | 0.099 | 1.086 | 0.078 |
| object | 0.495 | 0.256 | 0.331 | 1.226 | 0.215 |
| poly | 0.591 | 0.217 | 0.373 | 1.309 | 0.157 |
| rangeeach | 0.342 | 0.275 | 0.135 | 1.105 | 0.102 |
| send | 1.178 | 0.231 | 0.765 | 1.259 | 0.254 |
| sieve | 0.431 | 0.243 | 0.355 | 1.216 | 0.113 |
| sort | 0.408 | 0.351 | 0.199 | 1.154 | 0.143 |
| sprintfb | 0.531 | 0.500 | 0.663 | 1.628 | 0.620 |
| str | 0.822 | 0.633 | 0.607 | 1.437 | 0.464 |
| strcmp | 0.152 | 0.140 | 0.109 | 1.174 | 0.103 |
| strfmt | 0.729 | 0.622 | 0.740 | 1.636 | 0.662 |
| strops | 0.511 | 0.403 | 0.267 | 1.252 | 0.234 |
| strscan | 0.567 | 0.579 | 0.208 | 1.192 | 0.211 |
| structacc | 0.596 | 0.143 | 0.331 | 1.250 | 0.194 |
| tak | 1.463 | 0.208 | 0.937 | 1.334 | 0.305 |
| while | 0.813 | 0.784 | 0.830 | 1.074 | 0.070 |
| while2 | 0.420 | 0.093 | 0.419 | 0.986 | 0.026 |
| **geomean (参考)** | 1.00x | 0.48x | 0.64x | 2.15x | 0.30x |

(geomean 行は `make bench` の出力をそのまま転記した参考値。raw:
`bench-report/20260624-022141-bench-5mode.txt`。)
