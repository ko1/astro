...
static RESULT nil_to_a(CTX *c, int argc, VALUE *sp)  { return RESULT_OK(korb_ary_new(c, sp)); }
static RESULT nil_to_h(CTX *c, int argc, VALUE *sp)  { return RESULT_OK(korb_hash_new(c, sp)); }
