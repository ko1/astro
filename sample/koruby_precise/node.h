...
bool   korb_mod_hook_custom(CTX *c, VALUE mod, uint32_t mid);   /* module overrides a Module hook (const_added) */   /* owner = defining module (nil = top-level) — for Module#constants */
