...
// --- Drive AOT / PG bake through the code store ---
//
...
//
// The bake itself produces `code_store/all.so` via astro_cs_compile +
// astro_cs_build inside luastro_specialize_all; subsequent runs pick
// up the SDs through astro_cs_load on dlopen.
