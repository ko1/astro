...
|--------------|------:|------:|--------:|----------:|--------:|---------:|-------:|----------:|--------:|-------:|-------:|-------:|-------:|
| fib          |  9.12 |  1.12 |    4.34 |      0.80 |    0.73 |     0.78 |   0.71 |      0.82 |    0.71 |   0.46 |   0.40 |   0.12 |   0.14 |
| ackermann    |  6.29 |  0.73 |    6.06 |      0.92 |    0.87 |     0.84 |   0.76 |      0.94 |    0.85 |   0.53 |   0.31 |   0.05 |   0.06 |
| tak          |  1.20 |  0.20 |    0.60 |      0.23 |    0.14 |     0.19 |   0.11 |      0.25 |    0.11 |   0.06 |   0.05 |   0.04 |   0.02 |
| gcd          |  4.79 |  2.09 |    3.75 |      0.26 |    0.18 |     0.25 |   0.17 |      0.29 |    0.16 |   0.22 |   0.15 |   0.15 |   0.15 |
| loop         |  0.88 |  0.88 |    0.83 |      0.06 |    0.00 |     0.06 |   0.00 |      0.10 |    0.00 |   0.04 |   0.02 |   0.00 |   0.00 |
| call         | 18.44 |  5.34 |    6.02 |      1.74 |    1.59 |     1.43 |   1.21 |      1.15 |    0.86 |   1.09 |   1.07 |   0.31 |   0.32 |
| chain20      | 19.81 |  3.97 |    5.44 |      2.02 |    1.76 |     1.67 |   1.40 |      1.50 |    1.01 |   1.27 |   0.97 |   0.27 |   0.27 |
| chain40      | 20.80 |  3.83 |    6.45 |      3.49 |    3.06 |     3.52 |   2.98 |      2.08 |    1.18 |   2.49 |   2.24 |   0.25 |   0.25 |
| chain_add    |  2.11 |  0.65 |    0.99 |      0.32 |    0.16 |     0.28 |   0.12 |      0.37 |    0.08 |   0.11 |   0.10 |   0.03 |   0.03 |
| compose      |  2.37 |  1.26 |    1.22 |      0.23 |    0.13 |     0.22 |   0.13 |      0.24 |    0.08 |   0.10 |   0.09 |   0.09 |   0.09 |
| branch_dom   |  2.25 |  1.72 |    1.30 |      0.23 |    0.15 |     0.23 |   0.14 |      0.27 |    0.14 |   0.07 |   0.07 |   0.07 |   0.07 |
| deep_const   | 17.52 |  5.18 |    4.48 |      1.71 |    1.59 |     1.50 |   1.34 |      1.09 |    0.83 |   1.01 |   0.99 |   0.32 |   0.32 |
| collatz      |  5.38 |  0.87 |    3.43 |      0.24 |    0.16 |     0.24 |   0.16 |      0.28 |    0.15 |   0.34 |   0.15 |   0.14 |   0.14 |
| early_return |  5.77 |  0.70 |    4.20 |      0.37 |    0.28 |     0.37 |   0.28 |      0.41 |    0.28 |   0.30 |   0.28 |   0.28 |   0.28 |
| prime_count  |  9.30 |  3.46 |    6.96 |      0.53 |    0.44 |     0.54 |   0.45 |      0.58 |    0.45 |   0.49 |   0.43 |   0.43 |   0.43 |
...
|-------|------:|------:|------------:|
| fib          | 0.71 | 0.14 | 5.1× (gcc 勝) |
| ackermann    | 0.85 | 0.06 | 14.2× (gcc) |
| tak          | 0.11 | 0.02 | 5.5× (gcc) |
| gcd          | 0.16 | 0.15 | **1.07× ≈ tie** |
| loop         | 0.00 | 0.00 | DCE で比較不能 |
| call         | 0.86 | 0.32 | 2.7× (gcc) |
| chain20      | 1.01 | 0.27 | 3.7× (gcc) |
| chain40      | 1.18 | 0.25 | 4.7× (gcc) |
| chain_add    | 0.08 | 0.03 | 2.7× (gcc) |
| compose      | 0.08 | 0.09 | **0.89× (n 勝)** |
| branch_dom   | 0.14 | 0.07 | 2.0× (gcc) |
| deep_const   | 0.83 | 0.32 | 2.6× (gcc) |
...
★ chain 系 / call / branch_dom / deep_const は gcc-O3 に 2.0-4.7× 負けるが、
  これは callcache 2 段ガード check (cc serial + cc->body == sp_body、
  1 inline 段あたり 2 cmp + 2 jcc) の固定オーバーヘッド。
★ 再帰 3 種 (fib/ackermann/tak) は gcc-O3 に 5-14× 負ける。recursive な
...
|-------|-----:|------:|------:|------:|----------------------:|
| fib          | 4.34 | 5.9×  | 1.03× | 1.0×  | **6.1×** |
| ackermann    | 6.06 | 7.0×  | 1.14× | 0.89× | **7.1×** |
| tak          | 0.60 | 4.3×  | 1.27× | 1.0×  | **5.5×** |
| gcd          | 3.75 | 20.8× | 1.06× | 1.06× | **23.4×** |
| loop         | 0.83 | ∞ (DCE) | — | — | (DCE) |
| call         | 6.02 | 3.8×  | 1.31× | 1.41× | **7.0×** |
| chain20      | 5.44 | 3.1×  | 1.26× | 1.39× | **5.4×** |
| chain40      | 6.45 | 2.1×  | 1.03× | 2.53× | **5.5×** |
| chain_add    | 0.99 | 6.2×  | 1.33× | 1.50× | **12.4×** |
| compose      | 1.22 | 9.4×  | 1.0×  | 1.63× | **15.3×** |
| branch_dom   | 1.30 | 8.7×  | 1.07× | 1.0×  | **9.3×** |
| deep_const   | 4.48 | 2.8×  | 1.19× | 1.61× | **5.4×** |
| collatz      | 3.43 | 21.4× | 1.0×  | 1.07× | **22.9×** |
| early_return | 4.20 | 15.0× | 1.0×  | 1.0×  | **15.0×** |
| prime_count  | 6.96 | 15.8× | 0.98× | 1.0×  | **15.5×** |

★ **aot-c で 2-21×** (SD ベイク + 算術 inline)。
★ **aot-c → pg-c は 1.0-1.3× の小さな改善** ─ 公平化前 (PG が
...
★ **pg-c → lto-c は chain 系で 1.4-2.5× の改善** ─ クロス TU
  での PGSD chain 貫通 inline。再帰関数は HOPT cycle break で
  PGSD ≈ SD なので効果なし (≈1.0×)。
★ 総じて plain → lto-c で **5-23 倍速**。
...
|-------|------:|------:|----:|------:|------:|----:|
| fib       | 0.80 | 0.73 | 0.07 | 0.82 | 0.71 | 0.11 |
| ackermann | 0.92 | 0.87 | 0.05 | 0.94 | 0.85 | 0.09 |
| call      | 1.74 | 1.59 | 0.15 | 1.15 | 0.86 | 0.29 |
| chain20   | 2.02 | 1.76 | 0.26 | 1.50 | 1.01 | 0.49 |
| chain40   | 3.49 | 3.06 | 0.43 | 2.08 | 1.18 | 0.90 |
| collatz   | 0.24 | 0.16 | 0.08 | 0.28 | 0.15 | 0.13 |
| prime_count| 0.53| 0.44 | 0.09 | 0.58 | 0.45 | 0.13 |
...
mov    0x68(%rsi),%r10            ; sp_body load
cmp    0x58(%rsi),%rdx             ; ★ cc check #1: cc->serial vs c->serial
jne    <slowpath>
cmp    0x60(%rsi),%r10             ; ★ cc check #2: cc->body  vs sp_body
jne    <slowpath>
mov    0x68(%r10),%rsi             ; 次の sp_body load
... (次段の guard ペアがそのまま続く) ...
```

chain 10 段ぶんをまとめると: `cmp/jne` の対が 10 個、すべて inline。
深度 10 を **2 個の SD body** に焼き込み、本体には **indirect call が
1 つもない**。各段の guard が 2 命令対なので、旧 1 段時代から命令数は
ほぼ倍。それでも fast path だけで成立 (slowpath は `jne` 先のみ)。
...
4. **2 段ガード** — `c->serial == cc->serial && cc->body == sp_body` で
   ...
   (= 旧 demote 方式不要)。
5. **sp_body の direct call ベイク** — PG モードで SD が
   `SD_<HORG(sp_body)>` を C 定数としてベイク。
6. **HOPT/PGSD 投機チェイン** — sp_body を HOPT に含めることで
   chain 各レベルが固有の PGSD シンボルになり、LTO で貫通 inline 可能。
7. **`VALUE *fp` register-pass** — フレームポインタを dispatcher の第 3
   引数としてレジスタ渡し。`node_lget` / `node_lset` が `fp[idx]` 1 ロード。
8. **`--param=early-inlining-insns=100`** — gcc の early-inliner 予算を
