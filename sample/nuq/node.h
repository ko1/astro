...
EMIT nuq_walk_eval(CTX *c, struct Node *body);
EMIT nuq_recurse_eval(CTX *c, struct Node *body, struct Node *cond);
VALUE nuq_flatten_eval(VALUE arr, int depth);
EMIT nuq_flatten1_eval(CTX *c, struct Node *depth);
EMIT nuq_while_eval(CTX *c, struct Node *cond, struct Node *update);
EMIT nuq_until_eval(CTX *c, struct Node *cond, struct Node *update);
EMIT nuq_setpath_eval(CTX *c, struct Node *path, struct Node *value);
EMIT nuq_delpaths_eval(CTX *c, struct Node *paths);
EMIT nuq_assign_eval(CTX *c, struct Node *lhs, struct Node *rhs, uint32_t op_kind);
EMIT nuq_del_eval(CTX *c, struct Node *path_expr);
void nuq_leaf_paths_collect_pool(CTX *c, VALUE v);
...
EMIT nuq_path_eval(CTX *c, struct Node *body);
