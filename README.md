...
- [`sample/asom/`](./sample/asom/) — Smalltalk dialect ([SOM](https://som-st.github.io/)). Bundles SOM-st/SOM as a submodule for stdlib + TestSuite + AreWeFastYet. Passes 216/221 (97.7%) TestSuite assertions; 16 AWFY benchmarks pass.
