...
- [`sample/asom/`](./sample/asom/) — Smalltalk dialect ([SOM](https://som-st.github.io/)). Type-specialized sends, control-flow inlining, flonum-tagged Double, Boehm GC, GMP Bignum. SOM-st/SOM submodule for stdlib + TestSuite + AreWeFastYet; passes 216/221 TestSuite, IntegerTest 25/25 + DoubleTest 27/27. AOT beats SOM++ on all 12 AWFY (Sieve **20×**, QuickSort 10×, Queens 8×, Mandelbrot ~3×); PG-baked competitive with TruffleSOM warm peak.
