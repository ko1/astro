...
- [`sample/jstro/`](./sample/jstro/) — JavaScript (broad ES2023 subset). V8-style hidden-class objects with shape-transition ICs, monomorphic call ICs, longjmp `throw`, safepoint-driven mark-sweep GC. ~7 K hand-written lines.
